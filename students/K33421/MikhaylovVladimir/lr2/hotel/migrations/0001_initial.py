# Generated by Django 4.0.3 on 2022-03-09 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('STD', 'Standard'), ('BDR', 'With bedroom'), ('2BDR', 'With 2 bedrooms'), ('SUI', 'Suite'), ('KSU', 'King Suite'), ('VLL', 'Villa'), ('BGG', 'Bungalo')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.IntegerField(choices=[(1, 'Very Bad'), (2, 'Bad'), (3, 'Neutral'), (4, 'Good'), (5, 'Excellent')], null=True)),
