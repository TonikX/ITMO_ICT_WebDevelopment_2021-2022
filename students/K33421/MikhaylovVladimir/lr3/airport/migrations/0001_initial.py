    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tranzita', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='airport.tranzit', verbose_name='Транзит')),
            ],
        ),
        migrations.CreateModel(
            name='Remont',
            fields=[
                ...
                ('id_plane', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airport.plane', verbose_name='Самолёт')),
            ],
        ),
        migrations.CreateModel(
            name='Razrechenie',
            fields=[
                ...
                ('id_ekipazha', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airport.ekipazh', verbose_name='Экипаж')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start_tranzit', models.DateField(blank=True, null=True, verbose_name='Дата транзитной посадки')),
                ('time_start_tranzit', models.TimeField(blank=True, null=True, verbose_name='Время транзитной посадки')),
                ('date_end_tranzit', models.DateField(blank=True, null=True, verbose_name='Дата вылета из транзита')),
                ('time_end_tranzit', models.TimeField(blank=True, null=True, verbose_name='Время вылета из транзита')),
                ('id_plane', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airport.plane', verbose_name='Самолёт')),
                ('number_reysa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airport.reys', verbose_name='Номер-Рейс')),
            ],
        ),
        migrations.CreateModel(
            name='Dopusk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_workera', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='ФИО работника')),
            ],
        ),
        migrations.AddField(
            model_name='worker',
