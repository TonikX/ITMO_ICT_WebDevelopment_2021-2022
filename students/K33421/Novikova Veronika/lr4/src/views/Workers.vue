  ...
  methods: {
    ...
    deleteItemConfirm () {
      if (this.editedIndex > -1) {
        ...
        this.closeDelete()
        axios.delete('http://127.0.0.1:8000/workers/info/' + JSON.stringify(this.editedItem.id), {
    ...
    save () {
      if (this.editedIndex > -1) {
        ...
        axios.put('http://127.0.0.1:8000/workers/info/' + JSON.stringify(this.editedItem.id), {
          id: this.editedItem.id,
          name: this.editedItem.name,
          passport: this.editedItem.passport,
          salary: this.editedItem.salary
        ...
        axios.post('http://127.0.0.1:8000/workers/create/', {
          name: this.editedItem.name,
          passport: this.editedItem.passport,
          salary: this.editedItem.salary,
