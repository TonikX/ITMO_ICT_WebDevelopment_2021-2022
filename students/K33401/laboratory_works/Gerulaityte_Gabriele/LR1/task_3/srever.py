...
class MyHTTPServer:
    ...
    def handle_post_subjects(self, req):
        ...
        self._subjects[name].append(mark)
    ...
    def handle_get_subjects(self, req):
        ...
        if 'text/html' or '*/*' in accept:
            ...
            body = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title></title></head><body><table><tr><th>SUBJECT</th><th>MARK</th></tr>'
            for subject in self._subjects:
                body += f'<tr><td>{subject}:</td><td> {self._subjects[subject]}</td></tr>'
